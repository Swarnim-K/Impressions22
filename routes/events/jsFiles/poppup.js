function togglePopup(id) {
    ...
    var barIcn = document.getElementById("nvb2");
    ...
    var reg_btn = document.querySelectorAll("#reg_link_btn");
    ...
    switch (id) {
        case "SF":
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/StreetForward22";
            }
            break;
        ...
        case "SD":
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/soduet2022";
            }
            break;
        ...
        case "SW":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>It is a Bollywood Group Dance competition.</li> <li>Team Size: 5 - 15 members</li> <li>Registration Fee: 500/-</li> <li>Finals: 22nd December 2022</li> <li>Venue: COEP Technological University</li> <li>Styles permitted: All styles except Classical and Street dance forms</li> </ul>";
            EveStructure.innerHTML = "<h2>Structure:</h2>" + "<br/>" + "<br/>" + "<li>The competition will consist of a single round.</li> <li>Time Duration: 3 - 5 minutes, +1 minute setup time.</li> </ul>";
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/swagdesi2022";
            }
            break;
        ...
        case "NG":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: Solo</li> <li>Registration Fee: 100/-</li> <li>Dates: Eliminations - 22nd December 2022 and Finals - 23th December 2022</li> <li>Venue: COEP Technological University</li> </ul>";
            EveStructure.innerHTML = "<h2>Structure:</h2>" + "<br/>" + "<br/>" + "<h4>Eliminations:</h4>" + "<ul> <li>The contestants will perform in front of the judges.</li> <li>Time Limit: 3-5 minutes including setup time</li> <li>The selected participants will move to the next round.</li> <li>Participants can bring one accompanist with them.</li> </ul>" + "<h4>Finals:</h4>" + "<ul> <li>Participants shortlisted have to perform an extended version of their eliminations performance or a new one all together.</li> <li>Time Limit: 4-6 minutes including setup time</li> </ul>";
            EveRules.innerHTML = "<h2>Rules:</h2>" + "<br/>" + "<br/>" + "<ul>  <li>This competition is open for college students of age group 16-25.</li> <li>Only Kathak, Bharatanatyam and Odissi dance forms are allowed and all three will be judged separately.</li> <li>Folk and semi-classical dances are not permitted.</li> <li>Vulgarity and obscenity at any point are strictly not allowed.</li> <li>Props (except hazardous and dangerous materials) are allowed. List of all the props should be given 4 days prior to the fest. Only the props mentioned in the list are allowed.</li> <li>Participants can have one accompanist supporting their performance with live music. Only the registered participant is eligible for the prize.</li> <li>The music track should be submitted to the Event Head two days prior to the event. Also, the participants are requested to bring their tracks in a pen drive at the Impressions venue.</li></ul>";
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/nrityangana2022";
            }
            break;
        ...
        case "LL":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: Solo</li> <li>Entry Fees: INR 100/-</li> <li>Language: English / Hindi / Marathi</li> <li>Date: 22nd December 2022</li> <li>Venue: COEP Technological University</li> </ul>";
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/Limelight22";
            }
            break;
        ...
        case "AS":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: 3 - 10 (including backstage)</li> <li>Entry Fees: INR 500/- per team</li> <li>Language: English / Hindi / Marathi</li> <li>Time Duration: 7 - 10 minutes, including setup time.</li> <li>Date: 23rd December 2022</li> <li>Venue: COEP Technological University</li> </ul>";
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/artiskit22";
            }
            break;
        ...
        case "SS":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: 8 - 20 (Including all music accompanists)</li> <li>Entry Fees: INR 800/-</li> <li>Language: English / Hindi / Marathi</li> <li>Time Duration: 7 - 10 minutes, including setup time.</li> <li>Date: 24th December 2022</li> <li>Venue: COEP Technological University</li> </ul>";
            ...
            EveContact.innerHTML = "<h3>Have a query?</h3>"+ "<br/>" + "<h3>Contact Us:</h3>" + "<br/>" + "<br/>" + "<h5>Anuksha Koul -</h5>"+ "<br/>" + "<h5>(Event Coordinator of Suno Suno)</h5>" + "<br/>" + "<h5>Mob.- +91 9833290170</h5>";
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/sunosuno22";
            }
            break;
        ...
        case "DD":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team size: Solo</li> <li>Entry fees: INR 100/-</li> <li>Time Duration: 1.5 hours</li> <li>Date: 22nd December 2022</li> <li>Venue: COEP Technological University</li> </ul>";
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/doodlydoo22";
            }
            break;
        ...
        case "CK":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: Solo</li> <li>Entry fees: INR 100/-</li> <li>Time Duration: 1.5 hours</li> <li>Date: 24th December 2022</li> <li>Venue: COEP Technological University</li> </ul>";
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/cirkala22";
            }
            break;
        ...
        case "GOS":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: Solo</li> <li>Entry fees: INR 100/-</li> <li>Time Duration: 2.5 hours</li> <li>Date: 23rd December 2022</li> <li>Venue: COEP Technological University</li> </ul>";
            EveStructure.innerHTML = "<h2>Structure:</h2>" + "<br/>" + "<br/>" + "<ul>  <li>Themes will be disclosed at the time of the competition.</li> <li>Participants have to bring their own material- the necessary art supplies and a drawing board.</li> <li>Participants will be provided with a single A3 sheet.</li> <li>Participants have to complete their artwork in the above-mentioned time duration.</li> </ul>";
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/gameofshades22";
            }
            break;
        ...
        case "CS":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: Solo</li> <li>Entry fees: INR 100/-</li> <li>Time Duration: 2 hours</li> <li>Date: 22nd December 2022</li> <li>Venue: COEP Technological University</li> </ul>";
            EveStructure.innerHTML = "<h2>Structure:</h2>" + "<br/>" + "<br/>" + "<ul>  <li>Themes will be disclosed at the time of the competition.</li> <li>Participants have to bring their own material- the necessary art supplies and a drawing board.</li> <li>Participants will be provided with a single A3 sheet.</li> <li>Participants have to complete their artwork in the above-mentioned time duration.</li> </ul>";
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/coloursplash22";
            }
            break;
        ...
        case "GP":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: Solo</li> <li>Entry fees: INR 75/-</li> <li>Submission Deadline: IST 11:59 pm, 15th December 2022</li> </ul>";
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/graphix22";
            }
            break;
        ...
        case "BO":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: 10 (Maximum of 6 actors)</li> <li>Entry fees: INR 500/- per team.</li> <li>Time Limit: 15 minutes or under, including beginning and end credits.</li> <li>Submission Deadline: IST 11:59 pm, 15th December 2022</li> </ul>";
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/boxoffice22";
            }
            break;
        ...
        case "LA":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: Solo</li> <li>Entry Fees: INR 75/-</li> <li>Deadline: IST 11:59 pm, 15th December 2022.</li> </ul>";
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/lensart22";
            }
            break;
        ...
        case "BOJ":
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/battleofdjs22";
            }
            break;
        ...
        case "SVN":
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/saavani22";
            }
            break;
        ...
        case "ST":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: Solo (+1 accompanist)</li> <li>Registration Fee: INR 100/-</li> <li>All instruments are allowed (String, Wind, Percussion , Electronic, Acoustic).</li> <li>The competition is divided into two categories: Percussion and Non-Percussion Instruments.</li> <li>Dates: 23rd December 2022</li> <li>Venue:COEP Technological University</li> </ul>";
            EveStructure.innerHTML = "<h2>Structure:</h2>" + "<br/>" + "<br/>" + "<li>There will be only one round in the competition.</li> <li>Time Limit: 6 minutes including setup and clearance time (1+4+1)</li> </ul>";
            EveRules.innerHTML = "<h2>Rules:</h2>" + "<br/>" + "<br/>" + "<ul> <li>This competition is open for college students of age group 16-25.</li> <li>Each participant can use only one instrument per registration and can register for multiple categories separately. Participants have to carry their own instruments.</li> <li>Participants can have one accompanist supporting their performance, however only the registered participant is eligible for the prize.</li> <li>Vocals are not allowed in this competition.</li> <li>Use of pre-recorded music will lead to disqualification.</li> </ul>";
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/staytuned22";
            }
            break;
        ...
        case "PN":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: Solo (+1 beatboxer can accompany)</li> <li>Registration Fee: INR 100/-</li> <li>Date: 24th December 2022</li> <li>Venue:COEP Technological University</li> </ul>";
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/poona0522";
            }
            break;
        ...
        case "HC":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: 4 to 10 people</li> <li>Entry Fees: INR 600/-</li> <li>Date: 23rd December 2022</li> <li>Venue:COEP Technological University</li> </ul>";
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/highcurrent22";
            }
            break;
        ...
        case "AEB":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: Solo</li> <li>Entry Fees: INR 100/-</li> <li>Language: Hindi / Urdu / Marathi</li> <li>Dates: Eliminations - 23rd December 2022 and Finals - 24th December 2022</li> <li>Venue: COEP Technological University</li> </ul>";
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/andaazebayaan22";
            }
            break;
        ...
        case "TT":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: Solo</li> <li>Entry Fees: INR 100/-</li> <li>Language: English / Hindi</li> <li>Dates: 22nd December 2022</li> <li>Venue: COEP Technological University</li> </ul>";
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/taleteller22";
            }
            break;
        ...
        case "KK":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: Solo</li> <li>Entry Fees: INR 100/-</li> <li>Language: English / Hindi / Marathi</li> <li>Finals: 23rd December 2022</li> <li>Venue: COEP Technological University</li> </ul>";
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/Comiking22";
            }
            break;
        ...
        case "VA":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: Solo</li> <li>Entry Fees: INR 100/-</li> <li>Language: English / Hindi / Marathi</li> <li>Dates: Eliminations - 22rd December 2022 and Finals - 23rd December 2022</li> <li>Venue: COEP Technological University</li> </ul>";
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/versatile22";
            }
            break;
        ...
        case "AD":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: Solo</li> <li>Entry Fees: INR 80/-</li> <li>Language: English / Hindi / Marathi</li> <li>Submission deadline: 15th December 2022</li> </ul>";
            ...
            for (let i = 0; i < reg_btn.length; i++) {
                reg_btn[i].href = "https://www.townscript.com/e/anecdote22";
            }
            break;
